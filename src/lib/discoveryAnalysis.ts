...
const INNER_MESSAGES: Record<string, string> = {
  '認めてほしい': 'お母さん、もっと自分の頑張りを認めてもらいたいと感じているのかもしれません。それはとても自然で、大切な気持ちです。頑張ってきたこと、ちゃんと知っているよ。',
  '甘えたい': 'お母さん、本当は誰かにそっと頼ってみたいのかもしれません。甘えることは弱さじゃなくて、心を守るための大切な力です。',
  '安心したい': 'お母さん、ただ安心できる場所が欲しいのかもしれません。その感覚はとても大切。自分を守るために、安心を求めていいんです。',
  '分かってほしい': 'お母さん、ありのままの自分をわかってほしいと思っているのかもしれません。その気持ち、大切にしていいんです。あなたのことを知りたいと思っている人は、きっといます。',
  '可愛いと言われたい': 'お母さん、自分の柔らかい部分をもっと受け入れてもらいたいのかもしれません。そのままのあなたが、十分に素敵です。',
  '大切にされたい': 'お母さん、もっと大切にされてもいいと感じているのかもしれません。その感覚は正しい。大切にされる価値が、あなたにはあります。',
  '自由にしたい': 'お母さん、自分のペースで、もう少し自由に過ごしたいのかもしれません。その感覚、手放さないでください。あなたの時間はあなたのものです。',
}

const DIRECTION_THEMES: Partial<Record<string, string>> = {
  '人の役に立ちたい': '人のためだけでなく、自分の心が喜ぶ時間も同じくらい大切にしてみましょう。自分を満たすことが、誰かのためになります。',
  '穏やかに過ごしたい': '頑張りすぎずに、今日一日をていねいに過ごすこと。穏やかに生きることは、とても賢い選択です。',
  '好きなことを見つけたい': '好奇心の矢印を、自分自身にも向けてみましょう。「好き」を探すことに、年齢は関係ありません。',
  '自分の時間を持ちたい': '自分を後回しにしないで。小さな喜びをひとつ、毎日大切にしてみましょう。',
  '家族を大切にしたい': '大切な人との何気ない時間を、これからも守っていきましょう。その温かさが、あなたの強さです。',
  '意味のある日々': '毎日に小さな「意味」を見つけながら、積み重ねていきましょう。その積み重ねが、豊かな人生になっていきます。',
}

const ACTION_MAP: Record<string, string[]> = {
  '我慢癖': ['嫌だったことを、信頼できる人に一言だけ話してみましょう', '「我慢しなくていい」と、朝鏡の前で自分に言ってあげましょう'],
  '自己否定': ['毎日1つ、自分の「よかったこと」を書き留めてみましょう', '自分を責めそうになったら、「次はどうしようかな」と言い換えてみましょう'],
  '感情後回し': ['1日の終わりに「今日一番感じた気持ち」を一言だけメモしてみましょう'],
  '完璧主義': ['「80点でじゅうぶん」と決めて、気軽に動いてみる日をつくりましょう'],
  '自分を後回し': ['週に1回でいいので、自分のためだけの時間を30分とってみましょう'],
  '考えすぎ': ['頭の中のモヤモヤを紙に書き出して、頭の外に出してみましょう'],
  '不安を隠す': ['信頼できる人に、小さな不安をひとつだけ話してみましょう'],
  '相手優先': ['何かを決める前に「私はどうしたいかな」と、一度自分に聞いてみましょう'],
}

const DEFAULT_ACTIONS = [
  '毎日1つ、嬉しかったことや小さな喜びを書き留めてみましょう',
  '週に1回、自分のためだけの時間をつくってみましょう',
  '感じたことを、そのまま誰かに話してみましょう',
]
